        ...
        <div className="">
          <div className="container mx-auto px-4 py-8">
            ...
            <p className="mb-4">
              ...
              hard drive. Once you agree, the file is added, and the cookie
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                ...
                mind at any time by writing to or emailing us at [email
                protected]
              </li>
              <li>
              ...
              <li>
                ...
                you, please write to [Your Company Name, Address, City, State,
                Zip Code] or email [email protected]
              </li>
              <li>
